<?php
	  ...
	  // Admin settings
		...
		'bbar:admin:dboptsdesc'		=> 'Questo plugin puÃ² essere usato o dal nostro SQLite database oppure usando MySQL tramite oggetti ELGG. Se non sei sicuro dei settaggi da usare, utilizza SQLite',
